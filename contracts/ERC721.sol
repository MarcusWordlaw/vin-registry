...
contract ERC721 is ERC165, IERC721 {
     ...
     * @param tokenId bytes32 ID of the token to query the owner of
     ...
     * @param tokenId bytes32 ID of the token to be approved
     */
     ...
     * @param tokenId bytes32 ID of the token to query the approval of
     ...
     * @param tokenId bytes32 ID of the token to be transferred
     */
     ...
     */
    function safeTransferFrom(address from, address to, bytes32 tokenId, bytes memory _data) public {
     ...
     * @param tokenId bytes32 ID of the token to query the existence of
     ...
     * @param tokenId bytes32 ID of the token to be minted
     */
     ...
     * @param tokenId bytes32 ID of the token being burned
     */
     ...
     */
    function _checkOnERC721Received(address from, address to, bytes32 tokenId, bytes memory _data)
     ...
     * @param tokenId bytes32 ID of the token to be transferred
     */
    function _clearApproval(bytes32 tokenId) private {
